...
public class QuestionTwoActivity extends BaseActivity implements View.OnClickListener {
...
//                break;
    ...
    public void onYesClick(){
        ...
        questions.add(new Questions(getResources().getString(R.string.question2),getResources().getString(R.string.answer3)));
    ...
    public void onNoClick(){
        RealmList<Questions> questions = search.getQuestionsAttributes();
        questions.add(new Questions(getResources().getString(R.string.question2),getResources().getString(R.string.answer4)));
        search.setQuestionsAttributes(questions);
        new Utils().updateShared(this,search);
    }
}
